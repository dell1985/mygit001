...
ret1 = requests.get(url1, headers=headers)
ret2 = requests.get(url2, headers=headers)
ret3 = requests.get(url1).text
print(ret3)
print(data0)

r1 = ret1.content.decode()
r2 = ret2.content.decode()
print(r1)
print(r2)
rr1 = ret1.text  # 结果是字符串类型
rr2 = ret2.text
print(rr1)
print(rr2)
result1 = json.loads(rr1)
result2 = json.loads(rr2)
temp1 = result1['o_cursor']
temp2 = result2['o_curinstrument']
print(temp1)
print(temp2)

jsonbj1 = json.loads(ret1.text)
print(jsonbj1)
